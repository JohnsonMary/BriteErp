...
public class ApplicationConstants {
       ...
       public static final String ORDERS_HEADER = "Sales Orders";
       public static final String CUSTOMERS_HEADER = "Customers";
       public static final String ORDERS_TO_INVOICE_HEADER = "Orders to Invoice";
       public static final String ORDERS_TO_UPSEL_HEADER = "Orders to Upsell";
       public static final String PRODUCTS_HEADER = "Products";
       ...
       public static final String ACTIVE_HEADER_ORDERS_SALESORDERS = "Sales Orders";
       public static final String ACTIVE_HEADER_ORDERS_CUSTOMERS = "Customers";
